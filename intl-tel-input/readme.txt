...
Contributors: dansod, VanDeStouwe, FREEZhao, Muhammad Tariq Khan
...
For a complete overview of STC read: <a href="https://vandestouwe.com/stcmanual">STC's User Manual version 2.6.3</a>.
...
== Upgrade Notice ==
* solved bug in {{search_reason}}
* added {{post_excerpt}} and {{post_featured_image}}
* enhanced and improved STC Basic e-Mail Template V2.1 (delete older versions)
